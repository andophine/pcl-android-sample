...
JNIEXPORT jstring JNICALL Java_tw_com_hellopcl_MainActivity_boostMkDir
(JNIEnv * env, jobject)
{
  ...
  pcl::io::savePCDFileASCII ("/mnt/sdcard/PCL/output.pcd", *cloud);
	
	
	std::ofstream file ("/mnt/sdcard/PCL/caca.caca");
	file << "caca caca caca\n";
	file.close ();
